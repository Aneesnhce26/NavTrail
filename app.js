...
function generateMaze( rowStart, rowEnd, colStart, colEnd, surroundinWaLL,orientation){
    ...
    if(orientation === 'horizontal'){
        ...
        const randomCol = possibleCols[Math.floor(Math.random()* possibleRows.length)];
        ...
        //upper sub div
        generateMaze(rowStart,currentRow-2,colStart,colEnd,surroundinWaLL, ((currentRow-2) -rowStart> colEnd-colStart)? 'horizontal' : 'vertical' );
        //bottom sub div
        generateMaze(currentRow+2,rowEnd,colStart,colEnd,surroundinWaLL,(rowEnd-(currentRow+2) > colEnd - colStart)? 'horizontal' : 'vertical');
    }
    else{
        let possibleCols=[];
        ...
        const randomRow = possibleRows[Math.floor(Math.random()* possibleCols.length)];
        ...
        generateMaze(rowStart,rowEnd,colStart,currentCol-2,surroundinWaLL,(rowEnd-rowStart >(currentCol-2)-colStart)? 'horizontal':'vertical');
        generateMaze(rowStart,rowEnd,currentCol+2,colEnd,surroundinWaLL,(rowEnd - rowStart > colEnd-(currentCol+2))? 'horizontal':'vertical');
